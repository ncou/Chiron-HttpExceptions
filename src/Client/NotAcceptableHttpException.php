...
{
    private const STATUS_CODE = 406;
    private const TITLE = 'Not Acceptable';
    private const DETAIL = 'The requested resource is only capable of generating content not acceptable.';
    private const TYPE_URI = 'https://httpstatuses.com/406';
